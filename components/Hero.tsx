...
const Hero: React.FC<HeroProps> = ({ content }) => {
  ...
  */
  ...
  const isOpen = today >= 2 && today <= 6; // Tue (2) to Sat (6)

  const getStatusText = () => {
    if (!isOpen) return "Fechado hoje";
    return "Aberto hoje: 10:00 - 13:00, 14:30 - 19:30";
  };
          ...
          <div className="space-y-8 animate-fade-in-up z-10">
            ...
            <div className="pt-4 border-t border-slate-200/60">
              <p className="text-sm text-slate-500 flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-700">{getStatusText()}</span>
              </p>
